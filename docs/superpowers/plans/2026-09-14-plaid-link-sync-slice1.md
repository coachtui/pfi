...
- [ ] (in progress) Independent reviews: `code-reviewer`, `security-reviewer` (auth, tenancy, secrets, RPC flag, logging), `database-reviewer` (migration, trigger change, RPC, indexes). Fix findings.
