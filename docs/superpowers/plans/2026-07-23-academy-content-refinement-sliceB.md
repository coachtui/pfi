...
- `formulaRows`: `[{label:"Retained cash",staticValue:"$1,240"},{label:"Revenue",operator:"÷",staticValue:"$6,200"},{label:"Savings rate",operator:"=",staticValue:"20%"}]` — note: `operator` only supports `+`/`-`/`=`; use `"="` for the result row and put "÷" in the `formula` string fallback, or render the division in the `label` text of the revenue row (e.g. label `"÷ Revenue"`). Keep `formula: "Retained cash ÷ revenue = savings rate"` as the plain-text fallback.
...
- `formulaRows`: `[{label:"Cash and savings",staticValue:"$18,000"},{label:"Investments",operator:"+",staticValue:"$52,000"},{label:"Home and vehicles",operator:"+",staticValue:"$310,000"},{label:"Total assets",operator:"=",staticValue:"$380,000"}]`
...
- `formulaRows`: `[{label:"Mortgage balance",staticValue:"$248,000"},{label:"Auto loan",operator:"+",staticValue:"$14,500"},{label:"Credit-card balances",operator:"+",staticValue:"$3,200"},{label:"Total liabilities",operator:"=",staticValue:"$265,700"}]`
...
- `formulaRows`: `[{label:"Total assets",staticValue:"$380,000"},{label:"Total liabilities",operator:"-",staticValue:"$265,700"},{label:"Net worth",operator:"=",staticValue:"$114,300"}]`
...
- `formulaRows`: `[{label:"Liquid assets",staticValue:"$18,000"},{label:"Monthly essential costs",operator:"÷",staticValue:"$4,000"},{label:"Emergency runway",operator:"=",staticValue:"4.5 mo"}]` — same `÷` caveat as Task 7: put "÷" in the `formula` fallback and/or the row `label`; the result row uses `operator:"="`. Keep `formula: "Liquid assets ÷ monthly essential costs = runway in months"`.
...
- `formulaRows`: `[{label:"Monthly debt payments",staticValue:"$1,350"},{label:"Monthly income",operator:"÷",staticValue:"$6,200"},{label:"Debt burden",operator:"=",staticValue:"22%"}]` — same `÷` caveat; keep `formula: "Monthly debt payments ÷ monthly income = debt burden"`.
